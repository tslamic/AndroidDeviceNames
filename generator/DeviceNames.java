...
public final class DeviceNames {
    ...
    public static String getDeviceName(String model, String fallback) {
        ...
        switch (c) {
            case 'A':
if ("ASUS_Transformer_Pad_TF700T".equals(model)) { return "ASUS Transformer Pad TF700T"; }
...
break;
case 'C':
if ("C6833".equals(model)) { return "Sony Xperia Z Ultra"; }
...
else if ("C5302".equals(model)) { return "Xperia SP"; }
else if ("C5303".equals(model)) { return "Sony Xperia SP"; }
else if ("C5306".equals(model)) { return "Xperia SP"; }
...
break;
case 'B':
if ("bq_Aquaris_5".equals(model)) { return "bq Aquaris 5"; }
else if ("bq_Aquaris_5_HD".equals(model)) { return "bq Aquaris 5 HD"; }
break;
case 'E':
if ("EVO".equals(model)) { return "HTC Evo"; }
break;
case 'D':
if ("DROID_BIONIC".equals(model)) { return "Motorola Droid Bionic"; }
...
else if ("D2305".equals(model)) { return "Xperia M2"; }
else if ("D2306".equals(model)) { return "Xperia M2"; }
else if ("D2302".equals(model)) { return "Xperia M2"; }
else if ("D2303".equals(model)) { return "Sony Xperia M2"; }
else if ("Desire_HD".equals(model)) { return "HTC Desire HD"; }
break;
case 'G':
if ("GT-I9295".equals(model)) { return "Samsung Galaxy S4 Active"; }
...
else if ("GT-I9197".equals(model)) { return "Galaxy S4 Mini"; }
...
else if ("GT-I9210".equals(model)) { return "Galaxy S2"; }
else if ("GT-I9198".equals(model)) { return "Galaxy S4 Mini"; }
...
break;
case 'I':
if ("ISW11SC".equals(model)) { return "Galaxy S2"; }
break;
case 'H':
if ("HTC_Incredible_S".equals(model)) { return "HTC Incredible S"; }
...
break;
case 'K':
if ("Kindle_Fire".equals(model)) { return "Kindle Fire"; }
...
break;
case 'M':
if ("Motorola_Electrify".equals(model)) { return "Motorola Electrify"; }
...
break;
case 'L':
if ("LG-E970".equals(model)) { return "LG Optimus G"; }
...
break;
case 'O':
if ("Orange_Daytona".equals(model)) { return "Huawei Ascend G510"; }
break;
case 'N':
if ("Nexus_9".equals(model)) { return "Nexus 9"; }
...
break;
case 'Q':
if ("QMV7A".equals(model)) { return "Verizon Ellipsis 7"; }
break;
case 'P':
if ("PC36100".equals(model)) { return "HTC Evo 4G"; }
...
break;
case 'S':
if ("SCH-I415".equals(model)) { return "Samsung Galaxy Stratosphere II"; }
...
else if ("SHV-E300".equals(model)) { return "Galaxy S4"; }
else if ("SM-G920V".equals(model)) { return "Samsung Galaxy S6"; }
else if ("SM-G920R".equals(model)) { return "Galaxy S6"; }
else if ("SM-G920I".equals(model)) { return "Galaxy S6"; }
else if ("SM-G920F".equals(model)) { return "Galaxy S6"; }
...
else if ("SM-G9200".equals(model)) { return "Galaxy S6"; }
...
else if ("SGH-N045".equals(model)) { return "Galaxy S4"; }
...
else if ("SCH-I959".equals(model)) { return "Galaxy S4"; }
else if ("SCH-R760".equals(model)) { return "Galaxy S2"; }
...
else if ("SC-04E".equals(model)) { return "Galaxy S4"; }
else if ("SM-G900RZWAUSC".equals(model)) { return "Galaxy S5"; }
...
else if ("SM-G925A".equals(model)) { return "Galaxy S6 Edge"; }
...
else if ("SGH-N035".equals(model)) { return "Galaxy S3"; }
...
else if ("SM-G925P".equals(model)) { return "Galaxy S6 Edge"; }
...
else if ("SC-03E".equals(model)) { return "Galaxy S3"; }
...
else if ("SM-G925F".equals(model)) { return "Galaxy S6 Edge"; }
else if ("SPH-L520".equals(model)) { return "Samsung Galaxy S4 Mini"; }
else if ("SM-G925V".equals(model)) { return "Galaxy S6 Edge"; }
else if ("SM-G925R".equals(model)) { return "Galaxy S6 Edge"; }
...
else if ("SGH-N064".equals(model)) { return "Galaxy S3"; }
...
else if ("SC-02C".equals(model)) { return "Galaxy S2"; }
...
else if ("SCL21".equals(model)) { return "Galaxy S3"; }
...
else if ("SM-G925T".equals(model)) { return "Galaxy S6 Edge"; }
...
else if ("SM-G925W8".equals(model)) { return "Galaxy S6 Edge"; }
else if ("SGH-T599N".equals(model)) { return "Samsung Galaxy Exhibit"; }
else if ("SC-06D".equals(model)) { return "Galaxy S3"; }
else if ("SM-G386T".equals(model)) { return "Samsung Galaxy Avant"; }
else if ("SCH-I337".equals(model)) { return "Galaxy S4"; }
else if ("SCH-I939".equals(model)) { return "Galaxy S3"; }
...
else if ("SHW-M250".equals(model)) { return "Galaxy S2"; }
...
break;
case 'T':
if ("T-Mobile_myTouch_Q".equals(model)) { return "T-Mobile myTouch Q"; }
...
break;
case 'V':
if ("VS985_4G".equals(model)) { return "LG G3 4G"; }
...
break;
case 'X':
if ("XT1080".equals(model)) { return "Motorola Droid Ultra"; }
...
break;
case 'Z':
if ("Z970".equals(model)) { return "ZTE ZMax"; }
break;
default:
if ("5860E".equals(model)) { return "Coolpad Quattro 4G"; }
